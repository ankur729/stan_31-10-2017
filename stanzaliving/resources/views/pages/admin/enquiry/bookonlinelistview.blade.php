...
@endif
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">View Booking Online Leads   </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
<div class="Login-header with-border">
   <h3 class="login-details">Main Details</h3>
       ...
       <div class="col-xs-6 ">
        ...
        {!!     Form::text('e_name', $enquiry->phone,  ['class' => 'form-control', 'placeholder' => 'Event Name','disabled'=>'disabled']) !!}
          ...
          <div class="form_error"></div>
             ...
             <div class="col-xs-6 ">
        <div class="form-group">
           {!!Form::label('e_name', 'Nationality') !!}
      

        {!!     Form::text('e_name', $enquiry->nationality,  ['class' => 'form-control', 'placeholder' => 'Event Name','disabled'=>'disabled']) !!}
       ...
       <div class="col-xs-6">
        <div class="form-group">
           {!!Form::label('e_name', 'Parent’s / Guardian’s Name') !!}
      

        {!!     Form::text('e_name', $enquiry->parent_name,  ['class' => 'form-control', 'placeholder' => 'Event Name','disabled'=>'disabled']) !!}
          ...
          <div class="form_error"></div>
            ...
            <div class="col-xs-6">
        <div class="form-group">
           {!!Form::label('e_name', 'Parent’s / Guardian’s Email') !!}
      

        {!!     Form::text('e_name', $enquiry->parent_email,  ['class' => 'form-control', 'placeholder' => 'Event Name','disabled'=>'disabled']) !!}

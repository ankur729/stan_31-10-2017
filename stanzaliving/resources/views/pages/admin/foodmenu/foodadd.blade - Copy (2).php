    ...
    {!!     Form::select('f_cat', $myarr, null,  ['id' => 'food_cat', 'class' => 'form-control', 'placeholder' => '---Select Category---']) !!}
		...
		<div class="box-body after-add-more">
            <div class="col-xs-4">
				...
				<select class="form-control" name="weekday[][2]">
			...
			<div class="col-md-4">
				...
				<select name="fooditem[][2]" id="fooditemid"  multiple="multiple" style="height: 100px;width:100%;float:left;margin-left: 10px;">		
...
$(document).ready(function(){
  ...
  $(document).ready(function() {
    ...
    $(html).find(".change").html("<label for=''>"+length+"&nbsp;</label><br/><a class='btn btn-danger remove'>-Remove1</a>");

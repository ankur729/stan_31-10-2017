                 ...
                 <div class="col-xs-3">
                  <div class="form-group" style="margin-left: -31px;">
                    <label> &nbsp;</label><Br>
                     ...
                     <a href=" {{ url('admin/experience/image/add') }}" class="btn btn-success pull-left" style="margin:15px;display: block;float:right; ">Add New Image</a>
                   </div>
                 </div>
               </div>
             </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                ...
                <tbody>
		     	...
		     	@foreach($expimages as $key=>$expimage)
                  <tr>
                    <td>{{$key+1}}</td>
                    <td>{{$expimage->title}}</td>
                   
                    <td>
					<a href="{{action('ExpImageController@edit',['image_id'=>$expimage->id])}}"><i class="fa fa-edit" aria-hidden="true"></i></a>
				<!-- 	<a data-toggle="modal" data-target="#myModal"><i class="fa fa-trash md-trigger" ></i></a>

@{{action('AccessController@edit',[$role->id])}}
         -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <a href="{{action('ExpImageController@destroy',['image_id'=>$expimage->id])}}" data-method="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>

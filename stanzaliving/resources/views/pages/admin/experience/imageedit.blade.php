...
@endif
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="margin-bottom: 45px;">
  ...
  {!! Form::model($expimage,['url' => 'admin/experience/image/update','method' => 'put','files' => true]) !!}




          {!! Form::hidden('image_id', $expimage->id) !!}
             <div class="col-md-8">
             <div class="box-body">
               <div class="col-md-12">
    ...
    {!!     Form::text('desc', null,  ['class' => 'form-control', 'placeholder' => 'Image Description']) !!}
          ...
          <div class="form_error"></div>
               ...
               <div class="col-md-12">
                 <div class="form-group">
                    ...
                    {!!  Form::select('category',$myarr, $expimage->expcategory_id, array('class' => 'form-control','placeholder' => 'Please Select Category',)) !!}
          ...
          <div class="col-md-4">
               ...
               <div class="col-md-12">
                ...
                {!!Form::label('image', 'Add Category Image ') !!}
                  ...
                  <br>
                <img id="img_view" src=" {{ URL::to('images/categoryimage/'.$expimage->img)  }}" alt="your image"  style="width:100px;height:100px" />
          ...
          <div class="box-footer">
              <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-warning" style="margin-bottom:65px;">Edit Image</button>
              </div>
              </div>

...
{!! Form::open(['url' => 'admin/communicate_subcategory/save','method' => 'post']) !!}
    ...
    {!!     Form::text('name', null,  ['class' => 'form-control', 'placeholder' => 'Sub Category Name']) !!}
          ...
          <div class="box-footer">
              <div class="col-xs-4">
                ...
                <button type="submit" class="btn btn-success " style="margin-bottom:65px;margin-top: 22px;">Add Sub Category</button>
              </div>
              </div>

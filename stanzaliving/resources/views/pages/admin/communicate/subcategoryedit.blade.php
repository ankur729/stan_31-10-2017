...
{!! Form::model($subcategory,['url' => 'admin/communicate_subcategory/update','method' => 'put']) !!}
  ...
  {!! Form::hidden('id', $subcategory->id) !!}
    ...
    {!!     Form::select('cat_id', $myarr, null,  ['class' => 'form-control']) !!}
    ...
    {!!     Form::text('name', null,  ['class' => 'form-control', 'placeholder' => 'Sub Category Name']) !!}
          ...
          <div class="box-footer">
              <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-success pull-right" style="margin-bottom:65px;">Edit Sub Category</button>
              </div>
              </div>

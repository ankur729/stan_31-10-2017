...
@endif
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit :{{$payment->std_name}}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
<div class="Login-header with-border   after-border">
 ...
 <div class="box-body">
   <div class="col-xs-6 ">
    ...
    {!!     Form::text('std_reg_no', null,  ['class' => 'form-control reg', 'placeholder' => 'Registration Number', 'readonly'=>'readonly']) !!}
...
<div class="box-body">
    ...
    {!!     Form::text('inv_id', null,  ['class' => 'form-control inv_id']) !!}
    ...
    {!!     Form::text('inv_date', null,  ['class' => 'form-control inv_date']) !!}
    ...
    {!!     Form::text('electricity', null,  ['class' => 'form-control elec']) !!}
    ...
    {!!     Form::text('arrears', null,  ['class' => 'form-control arrears']) !!}
         ...
         <div class="box-body">
            ...
            {!!     Form::text('room_rent', null,  ['class' => 'form-control room']) !!}
            ...
            {!!     Form::text('inv_amt', null,  ['class' => 'form-control inv_amt','readonly'=>'readonly']) !!}
    ...
    {!!     Form::text('amt_pay', null,  ['class' => 'form-control amt_pay', 'placeholder' => 'Amount Payable','readonly'=>'readonly']) !!}
         ...
         <div class="box-body">
            ...
            {!!     Form::select('status', array('0'=>'Not Paid', '1'=>'Paid'), null,  ['class' => 'form-control tax','placeholder'=>'---Please Select Tax---']) !!}
          ...
          <div class="box-footer">
              <div class="col-md-12">
               ...
               <!--  <button type="submit" class="btn btn-back " style="margin-bottom:65px;">Back</button> -->
                <button type="submit" class="btn btn-success " style="margin-bottom:65px;">Edit</button>
              </div>
              </div>

                 ...
                 <div class="col-xs-3">
                  <div class="form-group" style="margin-left: -31px;">
                    <label> &nbsp;</label><Br>
                     ...
                     <a href=" {{ url('admin/room/add') }}" class="btn btn-success pull-left" style="margin:15px;display: block;float:right;">Add New Room</a>
                   </div>
                 </div>
               </div>
             </div>
        ...
        <div class="col-xs-12">
          ...
          @foreach($rooms as $key=>$room)
                  <tr>
                    ...
                    <td>
					<a href="{{action('RoomSharingController@edit',['room_id'=>$room->id])}}"><i class="fa fa-edit" aria-hidden="true"></i></a>
				<!-- 	<a data-toggle="modal" data-target="#myModal"><i class="fa fa-trash md-trigger" ></i></a>

@{{action('AccessController@edit',[$role->id])}}
         --> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <a href="{{action('RoomSharingController@destroy',['room_id'=>$room->id])}}" data-method="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
					</td>
           <!-- <td>
           <a href="{{action('RoomSharingController@destroy',['room_id'=>$room->id])}}" data-method="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
           </td> -->

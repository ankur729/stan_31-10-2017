        ...
        <div class="col-xs-12">
          ...
          <?php $stat=$food->status?'Active':'Deactive'; ?>
                  <tr>
                    ...
                    <td>{{$stat}}</td>
                    <td>
          <a title="Edit" href="{{action('FoodController@edit',['id'=>$food->id])}}"><i class="fa fa-edit" aria-hidden="true"></i></a>
        <!--  <a data-toggle="modal" data-target="#myModal"><i class="fa fa-trash md-trigger" ></i></a>

@{{action('AccessController@edit',[$role->id])}}
         -->
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <a title="Delete" href="{{action('FoodController@destroy',['id'=>$food->id])}}" data-method="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
           </td>
                  </tr>
             @endforeach
                        </tbody>

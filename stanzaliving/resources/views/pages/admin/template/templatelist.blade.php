...
@endif
   ...
   <!-- Main content -->
    ...
    @if($templatetype=='sms')
    <h3   style="text-align: center;padding:15px;"  >SMS Templates</h3>

    @elseif($templatetype=='email')
    <h3 style="text-align: center;padding:15px;"  >Email Templates</h3>
        ...
        <div class="col-xs-12">
          ...
          @foreach($templates as $key=>$template)
                  <tr>
                    ...
                    <td>
					<a href="{{url('admin/template/edit/'.$template->template_key) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
				<!-- 	<a data-toggle="modal" data-target="#myModal"><i class="fa fa-trash md-trigger" ></i></a>

@{{action('AccessController@edit',[$role->id])}}
         --> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <a href=" " data-method="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
					</td>

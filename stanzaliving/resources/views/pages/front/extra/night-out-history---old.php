	...
	<div class="menu-body">
		<div class="container">
			<ul class="panel-tabs">
				...
				<li class="list"><a href="#0" class="link">Late Night Requests</a></li>
...
<!-- 						<select class="select-option">
						...
						<div class="col-md-50 left padding-left-10px border-right">
							<input type="text" value="" id="demo-2" placeholder="Date & Time" class="input-box">
						</div>
						<div class="col-md-50 left padding-left-10px">
							<input type="time" value="" id="demo-2" placeholder="Expected Leaving Time" class="input-box">
						</div>
					</div>
				</div>
...
<!-- nightout dropdown selected option start-->
				...
				<div class="coloum-div">
					<div class="col-md-100 left padding-left-10px">
						<div class="col-md-25 left padding-left-10px border-right">
							<input type="text" value="" id="demo-2" placeholder="Leaving Date" class="input-box">
						</div>
						<div class="col-md-25 left padding-left-10px  border-right">
							<input type="time" value="" id="demo-2" placeholder="Leaving Time" class="input-box">
						</div>
						<div class="col-md-25 left border-right">
						<input type="text" value="" id="demo-2" placeholder="Return Date" class="input-box">
						</div>

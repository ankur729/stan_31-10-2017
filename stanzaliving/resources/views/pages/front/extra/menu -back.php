...
<div class="account-body food-menu-page">
	<div class="menu-body">
		<div class="container">
			<ul class="panel-tabs">
					...
					<div id="tab1_main" class="tab-slider--body" style="display: block;">
						<ul class="food-list">
							<li class="list">
								...
								<div class="food-set"><i class="icon"><img src="images/icon/veg.jpg"></i> Food Dish Name</div>
								<div class="food-set"><i class="icon"><img src="images/icon/veg.jpg"></i> Food Dish Name</div>
								<span class="eating-btn"><a href="#0" class="link">Eating</a></span>
								<span class="skipping-btn"><a href="#0" class="link">Skipping</a></span>
							</li>
							<li class="list">
								<h6 class="oca">Lunch
									<span class="time"> (09:00 - 10:30AM)</span>

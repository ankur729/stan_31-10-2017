	...
	<div class="menu-body">
		<div class="container">
			<ul class="panel-tabs">
				...
				<li class="list  active"><a href="student-profile.php" class="link">student profile</a></li>
				<li class="list"><a href="vox-populi.php" class="link">Vox Populi</a></li>
				<li class="list"><a href="late-night-out.php" class="link">Late Night Requests</a></li>
	...
	<div class="container">
		<div class="work-body">
			...
			<div class="widget-coloum student-profile-page">
				<div class="row">
				<h4 class="title">Personal Detai</h4>
				<div class="student-profile-box">
					<ul class="detail-list">
						<li class="list">
							<span class="label">Photo</span>
							<div class="data"><span class="thumb"><img src="images/icon/profile.jpg"></span></div>
						</li>
						<li class="list">
						...
						<li class="list">
							<span class="label">Registered Number Details for <br> Late-Night/Night-Out Requests</span>
							<span class="data">7838383838</span>
						</li>
						<li class="list">
							<span class="label">Home Address</span>
							<span class="data"> your address, your street, your block, your city, your country</span>
						</li>
					</ul>
				</div>
				</div>

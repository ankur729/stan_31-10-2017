...
<div class="account-body">
	...
	<div class="container">
		<div class="work-body">
			<div class="coloum-div right-btn">
					<a href="student-profile-update.php" class="right-update-btn" onclick="document.getElementById('id29').style.display='block'" class="w3-button w3-black">Change Registered Email Id</a>
...
<!-- 				<div class="coloum-div">
				...
				<div class="coloum-div">
					<div class="col-md-33 left border-right">
						<select class="select-option">
							<option>Select your category</option>
					...
					<div class="col-md-33 left padding-left-10px border-right">
						<input value="" id="demo-2" placeholder="Date of problem" class="input-box" type="text">
					</div> 
					<div class="col-md-33 left padding-left-10px">
						<input id="timepicker3" placeholder="Time of Leaving" name="timepicker2" data-timepicki-tim="07" data-timepicki-mini="13" data-timepicki-meri="PM" type="text">
					</div> 
				</div>
				<div class="coloum-div">
					<div class="left col-md-100 border-right">

							<div class="col-md-25 left padding-left-10px border-right">
								<input value="" id="demo-2" placeholder="Date Of Leaving" class="input-box" type="text">
							</div> 

							<div class="col-md-25 left padding-left-10px border-right">
								<input id="timepicker3" placeholder="Time of Leaving" name="timepicker1" data-timepicki-tim="07" data-timepicki-mini="13" data-timepicki-meri="PM" type="text">
							</div> 
							<div class="col-md-25 left padding-left-10px border-right">
								<input value="" id="demo-2" placeholder="Date Of Return" class="input-box" type="text">
							</div> 

							<div class="col-md-25 left padding-left-10px">
								<input id="timepicker3" placeholder="Time of Return" name="timepicker1" data-timepicki-tim="07" data-timepicki-mini="13" data-timepicki-meri="PM" type="text">
							</div> 
					</div>
